...
Write-Host ""
Write-Host "=== Creating specification: Phase 3.2 - Booking Saga ==="
Write-Host ""

Write-File "docs/specs/phase-3.2-booking-saga.md" @'
...
**Reason:** Infrastructure → foreign Application is an acceptable dependency
...
Write-Host "  notepad docs\specs\phase-3.2-booking-saga.md"
Write-Host ""
Write-Host "If approved:" -ForegroundColor Yellow
Write-Host "  git add ."
Write-Host '  git commit -m "docs(spec): SPEC-003.2 booking confirmation saga"'
Write-Host "  git push"
Write-Host ""
Write-Host "Then ask for script 3.2.1." -ForegroundColor Yellow
Write-Host ""