...
Write-Host ""
Write-Host "=== Continue 4.2: write files (skip npm install) ==="
Write-Host ""

$root = (Get-Location).Path

# Verify @angular/animations is installed
...
if ($pkg.dependencies.'@angular/animations') {
    Write-Host ("  @angular/animations = " + $pkg.dependencies.'@angular/animations') -ForegroundColor Green
} else {
    Write-Host "  @angular/animations NOT in package.json. Install manually:" -ForegroundColor Red
    Write-Host "    cd frontend"
    Write-Host "    npm install @angular/animations@22.1.0 --save --legacy-peer-deps"
    exit 1
}

# ===========================================================================
# styles.scss with PrimeNG 22 theme
# ===========================================================================
Write-Host ""
Write-Host "=== styles.scss ==="

Write-File "frontend/src/styles.scss" @'
/* PrimeNG 22 uses CSS variables via @primeng/themes. Base styles here. */
...
# ===========================================================================
# app.config.ts with PrimeNG theme preset
# ===========================================================================
Write-Host ""
Write-Host "=== app.config.ts ==="
